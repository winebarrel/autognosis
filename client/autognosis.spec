...
# wget https://bitbucket.org/winebarrel/autognosis/get/f38ca0bd5b22.tar.gz -O $RPM_SOURCE_DIR/
Source0:	f38ca0bd5b22.tar.gz
...
%prep
%setup -q -n winebarrel-autognosis-f38ca0bd5b22
